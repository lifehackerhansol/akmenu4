...
bool NdsBootstrapLauncher::launchRom(std::string romPath, std::string savePath, u32 flags, u32 cheatOffset, u32 cheatSize)
{
    ...
    // If it doesn't for some reason, default to `fat:/`, because most people are probably using this on flashcart
